...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("com/icon/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("com/icon/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLightDark.setIcon(new FlatSVGIcon("com/icon/dark.svg"));
        } else {
            buttonLightDark.setIcon(new FlatSVGIcon("com/icon/light.svg"));
        }
    }
