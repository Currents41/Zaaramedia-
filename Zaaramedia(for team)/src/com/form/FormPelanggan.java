...
import com.jdialog.FormInputPelanggan;
...
public class FormPelanggan extends javax.swing.JPanel {
    ...
    private void perbaruiData() {
        ...
        if(row != -1){
            ModelPelanggan pelanggan = tblModel.getData(row);
            FormInputPelanggan formInput = new FormInputPelanggan(null, true, row, pelanggan, this);
            formInput.setVisible(true);
            loadData();
        }else{
