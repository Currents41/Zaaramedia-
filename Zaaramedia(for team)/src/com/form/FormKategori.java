...
import com.jdialog.FormInputKategori;
...
public class FormKategori extends javax.swing.JPanel {
    ...
    private void perbaruiData() {
        ...
        if(row != -1){
            ModelKategori kategori = tblModel.getData(row);
            FormInputKategori formInput = new FormInputKategori(null, true, row, kategori, this);
            formInput.setVisible(true);
            loadData();
        }else{
